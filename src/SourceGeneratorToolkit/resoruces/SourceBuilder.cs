...
internal partial class SourceBuilder : ISourceBuilder
{
    ...
    {
        private readonly StringBuilder _sourceCode = initialSourceCode;
    ...
    public SourceBuilder(GeneratorAttributeSyntaxContext context)
        : this(context, CultureInfo.InvariantCulture)
    {
    }
        ...
        IFormatProvider formatProvider)
    {
        ...
        var initialSourceCode = new StringBuilder();
        initialSourceCode.AppendLine("// <auto-generated/>");
        initialSourceCode.AppendLine(usings.ToFullString());
        if (TargetType.ContainingNamespace is { } && !TargetType.ContainingNamespace.IsGlobalNamespace)
        {
            initialSourceCode.AppendLine($"namespace {TargetType.ContainingNamespace.ToDisplayString()};");
            initialSourceCode.AppendLine();
        }
        _state = new State(this, initialSourceCode);
    }
